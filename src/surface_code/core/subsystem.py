"""Subsystem-code algebra (phase-free), independent of geometry and circuits.

A subsystem code is defined by its gauge group G (here CSS: generated by
pure-X and pure-Z Pauli generators) and a choice of logical operators. The
stabilizer group S is the center of G. The codespace factors as
L (logical) x A (gauge qubits); distance is min |N(S) \\ G|.
"""
...
class SubsystemCode:
    ...
    def paulis_of_weight(self, weight: int) -> object:
        if weight == 0:
            yield Pauli()
            return
    ...
    def min_harmful_weight(self, max_weight: int | None = None) -> int | None:
        ...
        With max_weight=None this is the subsystem distance; searches weight 1..n.
        """
